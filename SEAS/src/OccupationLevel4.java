...
public class OccupationLevel4 {
	...
	@JsonProperty("_links") LinksOccupationLevel4 _links;
	...
	public LinksOccupationLevel4 getLinks() {
        return _links;
    }

    public void setLinks(LinksOccupationLevel4 _links) {
        this._links = _links;
    }
    /*
