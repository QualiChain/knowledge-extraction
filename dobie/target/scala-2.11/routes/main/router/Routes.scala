...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """annotate""", """controllers.HomeController.annotate"""),
  ...
  // @LINE:12
  private[this] lazy val controllers_HomeController_annotate3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("annotate")))
  )
  private[this] lazy val controllers_HomeController_annotate3_invoker = createInvoker(
    HomeController_0.annotate,
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "annotate",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:12
    case controllers_HomeController_annotate3_route(params) =>
      call { 
        controllers_HomeController_annotate3_invoker.call(HomeController_0.annotate)
      }
